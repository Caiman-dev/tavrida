        ...
        <main>
            ...
            <div class="container-white">
                ...
                <div class="text-block min-width">
                    ...
                    <p class="text">
                        2. Документ подтверждающий полномочия заявителя на владение транспортным средством ( тех паспорт автомобиля, доверенность, договор лизинга, договор купли -продажи, либо иной договор) в соответствии с законодательством Украины, ДНР, ЛНР, либо нормативно - правовыми актами Запорожской или Херсонской области выданные на транспортные средства до 30 сентября 2022 года.
                    </p><br>
                    <p class="text">
