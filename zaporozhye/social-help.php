        ...
        <main>
            ...
            <div class="container-white">
                <div class="heading min-width">
                    <span class="heding-text-1">Социальная поддержка</span>
                </div>
                <div class="social-buttons-block">
                    <div><a href="../zaporozhye/family.php" class="social-button"><img src="../assets/images/family.png" alt="family" /><span class="text-center">Семьям</span></a></div>
                    <div><a href="../zaporozhye/grand.php" class="social-button"><img src="../assets/images/grand.png" alt="grand" /><span class="text-center">Ветеранам и пенсионерам</span></a></div>
                    <div><a href="../zaporozhye/invalid.php" class="social-button"><img src="../assets/images/invalid.png" alt="invalid" /><span class="text-center">Инвалидам</span></a></div>
                </div>
            </div>
        </main>
        <footer>
